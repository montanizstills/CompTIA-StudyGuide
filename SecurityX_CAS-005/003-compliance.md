...
- HIPAA (Health Insurance Portability and Accountability Act)
  - Privacy Rule and Security Rule for protected health information (PHI)
  - Covers healthcare providers, health plans, and business associates
  - Requirements for safeguarding electronic PHI (ePHI)
  - Breach notification requirements
- HITECH (Health Information Technology for Economic and Clinical Health Act)
  - Enhanced HIPAA penalties and enforcement
  - Promotes adoption of electronic health records
- Medical device security requirements (FDA guidelines)
...
- GLBA (Gramm-Leach-Bliley Act)
  - Safeguards Rule for protecting customer financial information
- NYDFS Cybersecurity Regulation (23 NYCRR 500)
  - Requirements for financial institutions operating in New York
  - Risk assessments, documentation of policies, designation of CISO
- PCI DSS (specific to payment card data)
- FINRA (Financial Industry Regulatory Authority) requirements

## Government
- FISMA (Federal Information Security Modernization Act)
  - Risk-based security for federal agencies
- FedRAMP (Federal Risk and Authorization Management Program)
  - Cloud security assessment and authorization
- CMMC (Cybersecurity Maturity Model Certification)
  - Defense contractors requirements
  - Five maturity levels of cybersecurity practices
- State and local government requirements
- Special considerations for classified information
...
- SCADA (Supervisory Control and Data Acquisition) security requirements

# Industry Standards

## PCI DSS (Payment Card Industry Data Security Standard)
- 12 major requirements organized in 6 control objectives
- Scope determination and segmentation concepts
- Self-assessment questionnaires (SAQs) and reporting
...
- Fair business practices requirements
- Compliance obligations for large online platforms

## Additional Standards to Know
...
- CIS (Center for Internet Security) Benchmarks
  - Secure configuration guidance for operating systems, applications, cloud services
...
- Security benchmarking tools and methods
...
## Security Organization Control Type 2 (SOC2)
...
- Type 1 vs. Type 2 reports
  ...
  - Type 2: Assessment over a period (typically 6-12 months)
- Selecting applicable trust principles
...
- Framework profiles (Current and Target)
- Framework categories and subcategories
- NIST CSF integration with risk management
...
- Implementation and assessment methodologies
- Tools and resources for implementation

## Cloud Security Alliance (CSA)
- Cloud Controls Matrix (CCM)
- STAR Registry and certification levels
- Cloud security guidance and best practices
...
- Attestation standards (AICPA SOC reports, etc.)
- Compliance validation methods
- Gap analysis techniques
- External audit management and coordination

## Internal
- Internal audit function and reporting structure
- Self-assessments methodologies
...
- Data sharing and selling definitions
...
- Applicability to websites and online services
...
- POPI/POPIA (Protection of Personal Information Act) - South Africa
- State privacy laws (Virginia, Colorado, Utah, Connecticut)
...
- Electronic Stored Information (ESI) identification
- Preservation obligations
- Collection methodologies
- Processing of digital evidence
- Review procedures
- Production formats
- International considerations (Hague Convention, etc.)
- Data privacy conflicts

## Legal Holds
- Trigger events and identification
- Notification process
- Custodian acknowledgments
- Scope determination
- Preservation techniques
- Technology tools for legal holds
- Duration and release procedures
...
- Security questionnaires and evaluation
- Onsite assessments
- Technical testing
...
- Demonstrating adequate security controls
- Documentation of security decision-making
...
- Technology and encryption export restrictions
- Deemed exports (foreign nationals access)
